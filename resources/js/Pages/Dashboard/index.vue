                ...
                <div class="row align-items-center">
                  <div class="col-auto">
                    ...
                    <a href="#" class="avatar rounded-circle">
                      <img alt="Image placeholder" src="../../../src/img/theme/team-1.jpg">
                    </a>
                  </div>
                  <div class="col ml--2">
                    <h4 class="mb-0">
              ...
              <li class="list-group-item px-0">
                <div class="row align-items-center">
                  <div class="col-auto">
                    ...
                    <a href="#" class="avatar rounded-circle">
                      <img alt="Image placeholder" src="../../../src/img/theme/team-2.jpg">
                    </a>
                  </div>
                  <div class="col ml--2">
                    <h4 class="mb-0">
              ...
              <li class="list-group-item px-0">
                <div class="row align-items-center">
                  <div class="col-auto">
                    ...
                    <a href="#" class="avatar rounded-circle">
                      <img alt="Image placeholder" src="../../../src/img/theme/team-3.jpg">
                    </a>
                  </div>
                  <div class="col ml--2">
                    <h4 class="mb-0">
              ...
              <li class="list-group-item px-0">
                <div class="row align-items-center">
                  <div class="col-auto">
                    ...
                    <a href="#" class="avatar rounded-circle">
                      <img alt="Image placeholder" src="../../../src/img/theme/team-4.jpg">
                    </a>
                  </div>
                  <div class="col ml--2">
                    <h4 class="mb-0">
              ...
              <li class="list-group-item px-0">
                <div class="row align-items-center">
                  <div class="col-auto">
                    ...
                    <a href="#" class="avatar rounded-circle">
                      <img alt="Image placeholder" src="../../../src/img/theme/bootstrap.jpg">
                    </a>
                  </div>
                  <div class="col">
              ...
              <li class="list-group-item px-0">
                <div class="row align-items-center">
                  <div class="col-auto">
                    ...
                    <a href="#" class="avatar rounded-circle">
                      <img alt="Image placeholder" src="../../../src/img/theme/angular.jpg">
                    </a>
                  </div>
                  <div class="col">
              ...
              <li class="list-group-item px-0">
                <div class="row align-items-center">
                  <div class="col-auto">
                    ...
                    <a href="#" class="avatar rounded-circle">
                      <img alt="Image placeholder" src="../../../src/img/theme/sketch.jpg">
                    </a>
                  </div>
                  <div class="col">
              ...
              <li class="list-group-item px-0">
                <div class="row align-items-center">
                  <div class="col-auto">
                    ...
                    <a href="#" class="avatar rounded-circle">
                      <img alt="Image placeholder" src="../../../src/img/theme/react.jpg">
                    </a>
                  </div>
                  <div class="col">
        ...
        <div class="card">
          ...
          <div class="card-header d-flex align-items-center">
            <div class="d-flex align-items-center">
              <a href="#">
                <img src="../../../src/img/theme/team-1.jpg" class="avatar">
              </a>
              <div class="mx-3">
          ...
          <div class="card-body">
            ...
            <img alt="Image placeholder" src="../../../src/img/theme/img-1-1000x600.jpg" class="img-fluid rounded">
                ...
                <div class="d-flex align-items-center justify-content-sm-end">
                  <div class="avatar-group">
                    <a href="#" class="avatar avatar-xs rounded-circle" data-toggle="tooltip"
                      ...
                      <img alt="Image placeholder" src="../../../src/img/theme/team-1.jpg" class>
                    </a>
                    <a href="#" class="avatar avatar-xs rounded-circle" data-toggle="tooltip"
                      data-original-title="Audrey Love">
                      <img alt="Image placeholder" src="../../../src/img/theme/team-2.jpg" class="rounded-circle">
                    </a>
                    <a href="#" class="avatar avatar-xs rounded-circle" data-toggle="tooltip"
                      data-original-title="Michael Lewis">
                      <img alt="Image placeholder" src="../../../src/img/theme/team-3.jpg" class="rounded-circle">
                    </a>
                  </div>
            ...
            <div class="mb-1">
              <div class="media media-comment">
                <img alt="Image placeholder" class="avatar avatar-lg media-comment-avatar rounded-circle"
                  src="../../../src/img/theme/team-1.jpg">
                <div class="media-body">
                  <div class="media-comment-text">
                    <h6 class="h5 mt-0">Michael Lewis</h6>
                    <p class="text-sm lh-160">Cras sit amet nibh libero nulla vel metus scelerisque ante sollicitudin.
                      Cras purus odio vestibulum in vulputate viverra turpis.</p>
                    <div class="icon-actions">
                      <a href="#" class="like active">
                        <i class="ni ni-like-2"></i>
              ...
              <div class="media media-comment">
                <img alt="Image placeholder" class="avatar avatar-lg media-comment-avatar rounded-circle"
                  src="../../../src/img/theme/team-2.jpg">
                <div class="media-body">
                  <div class="media-comment-text">
                    <h6 class="h5 mt-0">Jessica Stones</h6>
                    <p class="text-sm lh-160">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque
                      ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.</p>
                    <div class="icon-actions">
                      <a href="#" class="like active">
                        <i class="ni ni-like-2"></i>
                  ...
                  <tbody class="list">
                    ...
                    <tr>
                      <th scope="row">
                        <div class="media align-items-center">
                          <a href="#" class="avatar rounded-circle mr-3">
                            <img alt="Image placeholder" src="../../../src/img/theme/vue.jpg">
                          </a>
                          <div class="media-body">
          ...
          <div class="card bg-gradient-danger">
            ...
            <div class="card-body">
              <div class="row justify-content-between align-items-center">
                <div class="col">
                  <img src="../../../src/img/icons/cards/bitcoin.png" alt="Image placeholder" />
                </div>
                <div class="col-auto">
